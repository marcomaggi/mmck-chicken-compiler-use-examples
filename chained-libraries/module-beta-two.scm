;; module-beta-two.scm --
;;
;; This file is part of the shared  library "library-beta"; we link this module along
;; with "module-beta-one".  We do *not* declare this file as a unit: this file is the
;; main one.   We declare that this  file uses "module-beta-one": the  invoke code of
;; "module-beta-one" is executed before the one of "module-beta-two".
;;
;; This file defines  a single module "module-beta-two" which we  want to import from
