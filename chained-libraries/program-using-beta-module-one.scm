...
;; We   declare   this   file  as   a   "unit",   so   that   the  invoke   code   of
;; "program-using-beta-module-one"     is    executed     before    the     one    of
;; "program-using-beta-module-main".  There is no need to declare any uses.
;;
;; This file defines  a single module "program-using-beta-module-one",  which we want
;; to  import from  other modules  in this  program: we  do need  to emit  the import
